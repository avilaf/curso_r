...
library("ggiraph") # create an interactive graphic to be used in a web browser

# install.packages("tidyverse")
library("tidyverse") # R Para Ciencia de Datos (https://es.r4ds.hadley.nz/)

# install.packages("patchwork")
library("patchwork") # for combining multiple plots

# install.packages("sf")
library("sf") # encode and analyze spatial vector data
...
data <- read.csv("03_datos/adn/complete_data_pulchella.csv", 
                 h = T)
